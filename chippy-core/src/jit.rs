...
//                 0x3 => {
//                     let (x, kk) = opcode.xkk();
//                     let addrx = self.registers.address(x) as i64;
//                     dynasm!(asm
//                         ; .arch x64
//                         ; mov rdx, QWORD addrx
//                         ; mov al, BYTE [rdx]
...
//                     let (x, y) = opcode.xy();
//                     let addrx = self.registers.address(x) as i64;
//                     let addry = self.registers.address(y) as i64;
//                     dynasm!(asm
//                         ; .arch x64
//                         ; mov rdx, QWORD addry
//                         ; mov al, BYTE [rdx]
...
//                 0x6 => {
//                     let (x, kk) = opcode.xkk();
//                     let addr = self.registers.address(x) as i64;
//                     dynasm!(asm
//                         ; .arch x64
//                         ; mov rdx, QWORD addr
...
//                             let addrx = self.registers.address(x) as i64;
//                             let addry = self.registers.address(y) as i64;
//                             let addrf = self.registers.address(0xF) as i64;
//                             dynasm!(asm
//                                 ; .arch x64
//                                 ; mov rdx, QWORD addry
//                                 ; mov al, BYTE [rdx]
...
//                 0xA => {
//                     let nnn = opcode.nnn();
//                     let addr = self.index.address(0) as i64;
//                     dynasm!(asm
//                         ; .arch x64
//                         ; mov rdx, QWORD addr
...
//                 0xB => {
//                     let nnn = opcode.nnn();
//                     let addr0 = self.registers.address(0) as i64;
//                     dynasm!(asm
//                         ; .arch x64
...
//                         let x = opcode.x();
//                         let addrx = self.registers.address(x) as i64;
//                         let addr_keys = self.keypad.keys.address(0) as i64;
//                         dynasm!(asm
//                             ; .arch x64
//                             ; mov rdx, QWORD addrx
//                             ; movzx rax, BYTE [rdx]
...
//                         let x = opcode.x();
//                         let addrx = self.registers.address(x) as i64;
//                         let addrdt = self.delay_timer.address(0) as i64;
//                         dynasm!(asm
//                             ; .arch x64
...
//                         let x = opcode.x();
//                         let addrx = self.registers.address(x) as i64;
//                         let addr_last_key = self.keypad.last_pressed.address(0) as i64;
//                         dynasm!(asm
//                             ; .arch x64
...
//                         let x = opcode.x();
//                         let addrx = self.registers.address(x) as i64;
//                         let addr_sound_timer = self.sound_timer.address(0) as i64;
//                         dynasm!(asm
//                             ; .arch x64
//                             ; mov rdx, QWORD addrx
//                             ; mov al, BYTE [rdx]
//                             ; mov rdx, QWORD addr_sound_timer
//                             ; mov BYTE [rdx], al
//                         );
//                     }
//                     0xF01E => {
//                         let x = opcode.x();
//                         let addrx = self.registers.address(x) as i64;
//                         let addri = self.index.address(0) as i64;
//                         dynasm!(asm
//                             ; .arch x64
//                             ; mov rdx, QWORD addrx
//                             ; movzx ax, BYTE [rdx]
...
//                         let x = opcode.x();
//                         let addr0 = self.registers.address(0) as i64;
//                         let addrlast = self.registers.address(x) as i64;
//                         let addri = self.index.address(0) as i64;
//                         let addrmem = self.memory.address(0) as i64;
//                         dynasm!(asm
//                             ; .arch x64
